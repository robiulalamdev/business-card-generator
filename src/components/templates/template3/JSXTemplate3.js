...
const JSXTemplate3 = () => {
  ...
  return (
    <div className="w-fit px-[10px] py-[10px] max-w-[515px] min-h-[250px]">
      {tempResult?.template?.signature && (
        <img
          src={tempResult?.template?.signature}
          alt=""
          className="max-w-[140px] max-h-[100px] w-full h-full object-contain"
        />
      )}
