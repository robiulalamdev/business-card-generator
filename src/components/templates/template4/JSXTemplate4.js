  ...
  return (
    <div className="w-fit px-[10px] py-[10px] max-w-[515px] min-h-[250px]">
      ...
      <div className="mt-[7px]">
        <p className="m-0 font-montserrat font-bold text-center text-[12px] text-white bg-[#434f68] px-[10px] py-[10px] break-words flex justify-between items-center border-b-[3px] border-[#db6b27] uppercase">
