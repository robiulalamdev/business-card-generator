      ...
      <table border="0" cellpadding="0" cellpadding="0" style="width:495px; font-family: 'Montserrat', sans-serif;min-width: 495px">
          <tr>
              <td valign="top" width="495" >
                  <p style="margin: 0; font-family: 'Montserrat', sans-serif;font-weight: normal;font-size: 12px;text-align: center;color: #ffffff;background-color: #db6b27; padding: 5px;">${data?.title}</p>
              </td>
          </tr>
      </table>
...
export const temp3HtmlSmall = async (data) => {
  return `<html lang="en">
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
